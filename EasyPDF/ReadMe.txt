========================================================================
    ACTIVEX 控件 DLL : EasyPDF 项目概述
========================================================================

控件向导已为 EasyPDF ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 EasyPDF ActiveX 控件 DLL 的每个文件的内容。
...
EasyPDFCtrl.h
    此文件包含 CEasyPDFCtrl C++ 类的声明。

EasyPDFCtrl.cpp
    此文件包含 CEasyPDFCtrl C++ 类的实现。

EasyPDFPropPage.h
    此文件包含 CEasyPDFPropPage C++ 类的声明。

EasyPDFPropPage.cpp
    此文件包含 CEasyPDFPropPage C++ 类的实现。

CEasyPDFCtrl.bmp
    此文件包含一个位图，当 CEasyPDFCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 EasyPDF.pch 的预编译头 (PCH) 文件和名为 
